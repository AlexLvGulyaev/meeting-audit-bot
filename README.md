...
> 🌐 **Живое демо:** <https://meeting-audit-bot.alex-n8n.site>  
...
> 📌 **Атрибуция:** проект развит на основе учебного проекта урока PEcb10 — исходный репозиторий урока: <https://github.com/MrGAN12009/stt_analyse>. Текущая версия — единый самодостаточный сервис с мультипровайдерным LLM, runtime-конфигурацией, веб-админкой и наблюдаемостью.
...
|-------|-----|-----------|
| **Telegram-бот** | @PEcb10_bot | Отправить аудио/видео, получить аудит |
| **Операторская панель** | `…/admin` | runtime-config, смена сценария аудита, observability |
...
MIT. Проект развит на основе учебного проекта урока PEcb10.
