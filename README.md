...
<img src="docs/screenshots/mab_portfolio_light.png" alt="Meeting Audit Bot — витрина кейса: Telegram-аудит звонка и панель оператора (LIGHT)">
...
> 🤖 **Живое демо — Telegram-бот:** @audit_bot  
...
|-------|-----|-----------|
| **Telegram-бот** | @audit_bot | Основная точка входа: отправить аудио/видео, получить аудит |
...
**Статус:** Production Ready — живое демо (Telegram + админка), Deployment Validation пройдена в чистом окружении (30.08)
